...
def buildFdrDict(data, rpcserver, sd_dict_list):
    ...
    for record in data:
        ...
        if fdr_dict['primary_affiliation'] == 'Faculty': # FDR "PRIMARY_AFFILIATION = "Faculty" are "academic and bibliographic searches are automatically performed
            fdr_dict['academic'] = 'Y'
        else:
            fdr_dict['academic'] = 'Y'  # "Student", "Staff", "Affiliate", and "Null" will not receive automatic searches
        fdr_dict['login'] = 'N'
